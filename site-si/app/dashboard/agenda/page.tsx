          ...
          <div className="flex flex-wrap gap-2">
            {!google.connected ? (
              ...
              <>
                ...
                <button type="button" onClick={() => resyncGoogle("restart_watch")} className="px-3 py-2 rounded-lg border border-theme bg-theme-card">
                  Reiniciar webhook
                </button>
                <button type="button" onClick={disconnectGoogle} className="px-3 py-2 rounded-lg bg-red-600 text-white">
                  Desconectar
                </button>
              </>
            )}
                ...
                <div className="space-y-1">
                  {dayEvents.map((ev) => (
                    <div
                      ...
                      className={`rounded px-2 py-1 text-xs cursor-move ${draggingEventId === ev.id ? "opacity-50" : ""}`}
